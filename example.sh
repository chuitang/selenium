...
echo "示例4：客户端使用代理的方法"
echo ""
echo "4.1 使用curl测试HTTP代理："
echo "curl -x http://localhost:8080 http://example.com"
echo ""
echo "4.2 使用curl测试HTTPS代理（CONNECT方法）："
echo "curl -x http://localhost:8080 https://www.google.com"
echo ""
echo "4.3 测试HTTPS代理连接："
echo "curl -v -x http://localhost:8080 https://httpbin.org/get"
echo ""
echo "4.4 配置浏览器代理："
echo "HTTP代理: localhost"
echo "端口: 8080"
echo "HTTPS代理: localhost"
echo "端口: 8080"
echo "用户名: 无需设置"
echo "密码: 无需设置"
echo ""
echo "4.5 使用Chrome启动时指定代理："
